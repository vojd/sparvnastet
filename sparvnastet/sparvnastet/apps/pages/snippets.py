...
def render_block_to_string(template_name, block, dictionary=None, context_instance=None):
    ...
    try:
        ...
        # Caught UncompressableFileError while rendering: 'shirtstheme/scss/style.scss' isn't accesible via COMPRESS_URL ('/static/') and can't be compressed
        # TODO: Fix compress error when compressing scss-file
        print e
